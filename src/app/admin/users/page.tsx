...
interface AdminUser {
    id: number;
    name: string;
    email: string; // Corporate email for admin
...
const initialAdminUsers: AdminUser[] = [
    { id: 1, name: "Síndico Principal", email: "sindico@digicondo.com", cpf: "111.111.111-11", role: "síndico" },
    { id: 2, name: "Admin Auxiliar", email: "admin@digicondo.com", cpf: "222.222.222-22", role: "admin" },
    { id: 3, name: "Supervisor Predial", email: "supervisor@digicondo.com", cpf: "333.333.333-33", role: "supervisor" },
];
...
export default function AdminUsersPage() {
    ...
    const [userCpf, setUserCpf] = useState(''); // Added state for CPF
    ...
    const handleSaveUser = async () => {
         if (!userName.trim() || !userEmail.trim() || !userCpf.trim() || !userRole) {
            toast({ title: "Erro", description: "Preencha nome, email, CPF e função.", variant: "destructive" });
            return;
        }
        ...
        // --- BACKEND NOTE ---
        // Implement actual user creation/update logic here.
        // - Securely hash passwords before storing.
        // - Ensure CPF uniqueness for admins.
        // - Verify corporate email domain if needed for 'admin' role.
        // - Apply SQL injection protection (e.g., prepared statements).
        if (editingUser) {
      ...
      const handleEditClick = (user: AdminUser) => {
        ...
        setUserCpf(user.cpf); // Set CPF on edit
     ...
     const handleRemoveUser = async () => {
        ...
        // --- BACKEND NOTE ---
        // Implement actual removal logic (send to backend).
        // Consider implications: revoking access, reassigning tasks etc.
        // Add check to prevent self-removal based on authenticated user ID.
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                 <div>
                    ...
                    <p className="text-muted-foreground">Adicione ou edite usuários com acesso administrativo (Síndicos, Supervisores, Staff DigiCondo).</p>
                </div>
                     ...
                     <CardContent className="space-y-4">
                          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                             ...
                             <div className="space-y-1.5">
                                 ...
                                 <Input id="user-email" type="email" placeholder="email@corporativo.com (Admin)" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} />
                             </div>
                             <div className="space-y-1.5">
                                 ...
                                 <Input
                                     ...
                                     value={userCpf}
                                     onChange={(e) => setUserCpf(e.target.value)} // TODO: Add CPF mask
                                 />
                                  {userCpf && !cpfRegex.test(userCpf) && (
                              ...
                              <div className="space-y-1.5">
                                  ...
                                  <Select value={userRole} onValueChange={(value) => setUserRole(value as AdminRole)}>
                                       ...
                                       <SelectContent>
                                          ...
                                          <SelectItem value="admin">Admin (DigiCondo)</SelectItem>
                                          <SelectItem value="supervisor">Supervisor Predial</SelectItem>
                                       </SelectContent>
                                  </Select>
                             </div>
                                ...
                                <TableBody>
                                    {adminUsers.map((user) => (
                                        <TableRow key={user.id}>
                                            ...
                                            <TableCell>{user.cpf}</TableCell> {/* Display CPF */}
                                                ...
                                                <Button variant="ghost" size="icon" title="Editar" onClick={() => handleEditClick(user)}>
                                                 ...
                                                 <AlertDialog>
                                                     <AlertDialogTrigger asChild>
                                                         {/* TODO: Disable remove button for self based on logged-in user ID */}
